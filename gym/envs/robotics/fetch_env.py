...
class FetchEnv(robot_env.RobotEnv):
    ...
    def _get_obs(self):
        ...
        return {
            ...
            'my_new_observation' : my_new_observation.copy(),
        }
    ...
    def _reset_sim(self):
        ...
        if self.has_object:
            ...
            for name_string in ['object0:joint', 'object1:joint', 'object2:joint', 'bow0:joint', 'bow1:joint', 'bow2:joint']:
                ...
                gripper_start_pos = self.initial_gripper_xpos[:2] + position_list[self.object_position[i]]
                object_xpos = gripper_start_pos + self.np_random.uniform(-self.obj_range, self.obj_range, size=2)
                object_qpos = self.sim.data.get_joint_qpos(name_string)
                assert object_qpos.shape == (7,)
                object_qpos[:2] = object_xpos
                self.sim.data.set_joint_qpos(name_string, object_qpos)
    ...
    def _sample_goal(self):
        if self.has_object:
            ...
            position_list = [[init_x,       0.0,    0], 
                            [init_x,        +delta, 0], 
                            [init_x,        -delta, 0], 

                            [init_x+delta,  0.0,    0], 
                            [init_x+delta,  +delta, 0],
                            [init_x+delta,  -delta, 0], 
            ...
            goal += position_list[self.object_position[6]]
    ...
    def _sample_goal_1(self):
        if self.has_object:
            ...
            goal = self.initial_gripper_xpos[:3] + self.np_random.uniform(-self.target_range, self.target_range, size=3)
            goal += self.target_offset
            goal += position_list[self.object_position[7]]
            goal[2] = self.height_offset
            if self.target_in_the_air and self.np_random.uniform() < 0.5:
                goal[2] += self.np_random.uniform(0, 0.45)
        else:
    ...
    def _sample_goal_2(self):
        if self.has_object:
            ...
            goal = self.initial_gripper_xpos[:3] + self.np_random.uniform(-self.target_range, self.target_range, size=3)
            goal += self.target_offset
            goal += position_list[self.object_position[8]]
            goal[2] = self.height_offset
            if self.target_in_the_air and self.np_random.uniform() < 0.5:
                goal[2] += self.np_random.uniform(0, 0.45)
        else:
...
class FetchEnvOneObject(robot_env.RobotEnvOneObject):
    """Superclass for all Fetch environments.
    """
    ...
    def __init__(
        ...
        super(FetchEnvOneObject, self).__init__(
            model_path=model_path, n_substeps=n_substeps, n_actions=4,
            initial_qpos=initial_qpos)
...
class FetchEnvTwoObject(robot_env.RobotEnvTwoObject):
    """Superclass for all Fetch environments.
    """
    ...
    def __init__(
        ...
        super(FetchEnvTwoObject, self).__init__(
            model_path=model_path, n_substeps=n_substeps, n_actions=4,
            initial_qpos=initial_qpos)
...
class FetchEnvTwoGasket(robot_env.RobotEnvTwoGasket):
    """Superclass for all Fetch environments.
    """
    ...
    def __init__(
        ...
        super(FetchEnvTwoGasket, self).__init__(
            model_path=model_path, n_substeps=n_substeps, n_actions=4,
            initial_qpos=initial_qpos)
